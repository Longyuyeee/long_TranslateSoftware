...
| 平台 | 文件类型 | 下载链接 |
| :--- | :--- | :--- |
| **Windows (x64)** | **[推荐] NSIS 安装程序** | **[立即下载 v0.2.3 .exe](releases/LongTranslate_0.2.3_x64_Setup.exe)** |
| **Windows (x64)** | **MSI 安装包** | **[立即下载 v0.2.3 .msi](releases/LongTranslate_0.2.3_x64_zh-CN.msi)** |
