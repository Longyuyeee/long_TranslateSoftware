...
| 当前进展 | PR #22～#27 已合并；双模型对比与旧兼容入口边界正在独立分支推进 | 正常 |
| 前端测试 | 40 个文件 / 175 项 | 通过 |
...
| `api.ts` | 229 行 | 传输、单次任务/缓存/主备切换及双模型对比/旧兼容流程已拆分；仅 TTS 门面仍集中 |
