...
| 当前进展 | PR #22～#26 已合并；单次翻译任务与主备切换边界正在独立分支推进 | 正常 |
| 前端测试 | 40 个文件 / 174 项 | 通过 |
...
| `api.ts` | 476 行 | 传输及单次任务/缓存/主备切换已拆分；双模型对比、旧兼容流程和 TTS 仍集中 |
