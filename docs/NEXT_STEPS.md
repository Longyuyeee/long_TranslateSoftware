...
- 当前自动化基线：前端 40 个测试文件、173 项测试，Rust 64 项测试（含 2 项真实子进程测试）；生产 JavaScript 最大块为 234.55 KiB。
...
1. 继续拆分 `api.ts` 的翻译任务、缓存和主备故障切换策略，并保留兼容出口。
2. 拆分 `GeneralSettingsTab.tsx` 的 WebDAV、快捷键和维护区块，降低单页复杂度。
