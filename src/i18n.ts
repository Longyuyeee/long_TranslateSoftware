...
const zh = {
    ...
    documentRecoveryLoadedDescription: "已恢复本机进度，本步骤不会自动继续翻译。",
...
const en: TranslationCatalog = {
    ...
    documentRecoveryLoadedDescription: "Local progress was restored. Translation will not continue automatically in this step.",
