...
const zh = {
    ...
    documentRecoveryAwaitingRebuild: "译文分段已经完整保存，等待下一步接通 DOCX 重建与导出。",
...
const en: TranslationCatalog = {
    ...
    documentRecoveryAwaitingRebuild: "All translated segments are safely stored and await DOCX reconstruction and export in the next step.",
